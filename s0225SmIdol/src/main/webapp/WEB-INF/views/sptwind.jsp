...
<div class="wrapper">
  ...
  <div class="left-col">
    ...
    <div class="box">
      <h3>주소</h3>
      <input type="text" id="sample6_postcode" class="addressInput" placeholder="우편번호">
      <input type="button" id="addAddressBtn" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br><br>
    ...
    <div class="box">
      <h3>Option</h3>
      <label for="shippingSelect" id="shippingLabel">Shipping Option</label>
    ...
    <div class="box">
      <h3>Site rewards</h3>
      <label for="rewardSelect" id="rewardLabel">Choose Reward</label>

...
<div id="wrap">
    ...
    <div id="container">
        <div id="content">
            ...
            <form action="naver_index2.jsp">
                <fieldset style="border: 0">
                    <div class="id_area">
                        <div class="input_row" id="id_area">
                            <span class="input_box">
                                <input type="text" name="" id="uId" class="int" placeholder="아이디">
                            </span>
                        </div>
                    </div>
                    <div class="pw_area">
                    ...
                    <br />
                    <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=84ca5be62566e03d78c3ddbba708b29c&redirect_uri=http://localhost:8181/kakao/oauth">
